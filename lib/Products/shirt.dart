...
Future<void> shirt(BuildContext context, String id, String name) async {
  ...
  TextEditingController neckCircumference = TextEditingController();
  ...
  TextEditingController cuffCircumference = TextEditingController();
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: MyTextForm(
                          labeltext: "*Cuff Circumference",
                          controller: cuffCircumference,
                          inputType: TextInputType.number,
                        ),
                      ),
                      const SizedBox(
                            ...
                            if (amount != null && value != null) {
                              ...
                              try {
                                await FirebaseFirestore.instance
                                  ...
                                  "Neck Circumference": neckCircumference.text,
                                  ...
                                  "bicep": bicep.text,
                                  "Cuff Circumference": cuffCircumference.text,
